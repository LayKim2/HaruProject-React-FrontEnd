                ...
                <div class="container pb-lg-3">
                    ...
                    <div class="row">
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                <div class="men-thumb-item">
                                    <img src="assets/images/s1.jpg" class="img-fluid" alt=""></img>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                <div class="men-thumb-item">
                                    <img src="assets/images/s2.jpg" class="img-fluid" alt=""></img>
                                    <span class="product-new-top">New</span>
                                </div>
                                <div class="item-info-product">
                                    <h4>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                <div class="men-thumb-item">
                                    <img src="assets/images/s3.jpg" class="img-fluid" alt=""></img>
                                    <span class="product-new-top">New</span>
                                </div>
                                <div class="item-info-product">
                                    <h4>
                        ...
                        <div class="col-md-4 product-men my-lg-4">
                            <div class="product-shoe-info shoe text-center">
                                <div class="men-thumb-item">
                                    <img src="assets/images/s4.jpg" class="img-fluid" alt=""></img>
                                    <span class="product-new-top">New</span>
                                </div>
                                <div class="item-info-product">
                                    <h4>
                        ...
                        <div class="col-md-4 product-men my-lg-4">
                            <div class="product-shoe-info shoe text-center">
                                <div class="men-thumb-item">
                                    <img src="assets/images/s5.jpg" class="img-fluid" alt=""></img>
                                    <span class="product-new-top">New</span>
                                </div>
                                <div class="item-info-product">
                                    <h4>
                        ...
                        <div class="col-md-4 product-men my-lg-4">
                            <div class="product-shoe-info shoe text-center">
                                <div class="men-thumb-item">
                                    <img src="assets/images/s6.jpg" class="img-fluid" alt=""></img>
                                    <span class="product-new-top">New</span>
                                </div>
                                <div class="item-info-product">
                                    <h4>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                <div class="men-thumb-item">
                                    <img src="assets/images/s7.jpg" class="img-fluid" alt=""></img>
                                    <span class="product-new-top">New</span>
                                </div>
                                <div class="item-info-product">
                                    <h4>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                <div class="men-thumb-item">
                                    <img src="assets/images/s8.jpg" class="img-fluid" alt=""></img>
                                    <span class="product-new-top">New</span>
                                </div>
                                <div class="item-info-product">
                                    <h4>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                <div class="men-thumb-item">
                                    <img src="assets/images/s9.jpg" class="img-fluid" alt=""></img>
                                    <span class="product-new-top">New</span>
                                </div>
                                <div class="item-info-product">
                                    <h4>
                ...
                <div class="container pb-lg-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 latest-left">
                            <div class="product-shoe-info shoe text-center">
                                <img src="assets/images/img1.jpg" class="img-fluid" alt=""></img>
                        ...
                        <div class="col-md-6 latest-right">
                            <div class="row latest-grids">
                                <div class="latest-grid1 product-men col-12">
                                    <div class="product-shoe-info shoe text-center">
                                        <div class="men-thumb-item">
                                            <img src="assets/images/img2.jpg" class="img-fluid" alt=""></img>
                                            <div class="shop-now"><a href="shop.html" class="btn">Shop Now</a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="latest-grid2 product-men col-12 mt-lg-4">
                                    <div class="product-shoe-info shoe text-center">
                                        <div class="men-thumb-item">
                                            <img src="assets/images/img3.jpg" class="img-fluid" alt=""></img>
                                            <div class="shop-now"><a href="shop.html" class="btn">Shop Now</a></div>
